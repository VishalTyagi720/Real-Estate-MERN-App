        ...
        <main> 
            ...
            {listing && !loading && !error && (
                <div>
                    ...
                    <div className="cursor-pointer fixed top-[20%] right-[3%] z-10 border rounded-full w-12 h-12 flex justify-center items-center bg-slate-100">
                    ...
                    {copied && <p className="fixed top-[30%] right-[5%] z-10 rounded-md bg-slate-200 p-2 transition-all duration-1000 delay-1000 ease-in-out">Link copied!!</p>}
                    <div className="flex flex-col max-w-4xl mx-auto p-3 my-7 gap-4">
                        ...
                        {currentUser && listing.userRef === currentUser.data._id && !contact && (
                            <button onClick={() => setContact(true)} className="bg-slate-700 text-white rounded-lg uppercase p-3 hover:opacity-90">contact lanlord</button>
                        )}
